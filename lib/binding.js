...
var fxlibPath = path.join(__dirname, '..', 'build', 'libueyefx.so');

var localExists = fs.existsSync(fxlibPath);

exports.libueye = new FFI.Library(localExists ? fxlibPath : 'libueye_api', {
